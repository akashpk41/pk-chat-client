      ...
      <div className="card bg-base-100 shadow-2xl border-2 border-base-300/50 hover:border-primary/30 transition-all duration-300">
        <div className="card-body p-4">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className={`badge badge-lg gap-2 ${isUpdatingProfile ? 'badge-warning' : 'badge-success'} shadow-lg`}>
              <div className={`w-2 h-2 rounded-full ${isUpdatingProfile ? 'bg-warning-content' : 'bg-success-content'} ${isUpdatingProfile ? 'animate-pulse' : 'animate-ping'}`} />
          ...
          <div className="flex flex-col sm:flex-row items-center gap-8 p-8 bg-gradient-to-br from-base-200/80 to-base-300/80 rounded-2xl border border-base-300/50">
            ...
            <div className="flex-1 text-center sm:text-left space-y-3">
              ...
              <div className="flex flex-wrap gap-2 justify-center sm:justify-start">
                ...
                <div className="badge badge-outline badge-lg border-2">JPG, PNG, GIF</div>
              </div>
            </div>
          </div>
        </div>
