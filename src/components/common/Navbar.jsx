...
const Navbar = () => {
  ...
  return (
    <header
      className="sticky  z-50 bg-base-100/80 backdrop-blur-lg border-b border-base-300"
    >
  ...
  >
    <div className="relative size-9">
      ...
      {/* Inner Pulsing Glow */}
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="w-6 h-6 rounded-full bg-gradient-to-br from-purple-600 to-blue-600 opacity-30 blur-lg animate-pulse" style={{ animationDuration: '2s' }}></div>
      </div>
