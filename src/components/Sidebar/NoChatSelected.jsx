  ...
  return (
    <div className="w-full flex flex-1 flex-col items-center justify-center p-1 bg-base-100/50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-[15%] right-[25%] animate-bounce opacity-35"
      ...
      <div className="max-w-md text-center space-y-6 relative z-10">
        ...
        <div className="flex justify-center gap-4 mb-4 animate-bounce" style={{ animationDuration: '5s' }}>
          <div className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-24 h-24 rounded-full bg-gradient-to-tr from-pink-500/30 via-purple-500/30 to-pink-500/30 animate-pulse blur-md"
                   style={{ animationDuration: '4.5s', animationDelay: '2s' }}></div>
            </div>
            ...
            <div className="absolute -bottom-2 -right-2 w-3 h-3 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-full animate-ping"
                 style={{ animationDuration: '4.8s', animationDelay: '1.5s' }}></div>
          </div>
        </div>

        {/* Welcome Text with Floating Animation */}
        <div className="space-y-3 animate-bounce" style={{ animationDuration: '4s', animationDelay: '0.5s' }}>
          ...
          <p className="text-base-content/80 text-base font-medium animate-pulse" style={{ animationDuration: '4s' }}>
            Select a conversation from the sidebar to start chatting
          </p>
        </div>

        {/* Enhanced Feature Pills with Icons */}
        <div className="flex flex-wrap justify-center gap-3 pt-4 animate-bounce" style={{ animationDuration: '4.5s', animationDelay: '1s' }}>
        ...
        {/* Animated Tip Box */}
        <div className="pt-6 animate-bounce" style={{ animationDuration: '5s', animationDelay: '2s' }}>
          <div className="inline-block px-6 py-3 rounded-xl bg-gradient-to-r from-purple-500/20 via-pink-500/20 to-blue-500/20 border-2 border-purple-500/50 backdrop-blur-sm shadow-lg hover:shadow-xl transition-shadow duration-300">
            <p className="text-base font-bold flex items-center gap-2">
              <Sparkles className="w-5 h-5 text-purple-500 animate-bounce" style={{ animationDuration: '3s' }} />
        ...
        {/* Status Indicator */}
        <div className="pt-4 animate-pulse" style={{ animationDuration: '4s', animationDelay: '1s' }}>
          <div className="flex items-center justify-center gap-2 text-sm">
            <div className="w-2 h-2 bg-green-500 rounded-full animate-ping"></div>
            <span className="text-base-content/60 font-medium">Online & Ready</span>
          </div>
        </div>
      </div>
    </div>
